export function Container() {
  return (
    <div className="  h-screen max-md:h-5/6  pt-96 xl:pt-64 max-md:pt-16 ">
      ...
      <div className=" font-bold">
        ...
        <h4 className="fontRoboto mt-10 2xl:text-lg max-md:text-xs text-cyan-600 ">
  ...
  return (
    <div className="relative group">
      <img
        ...
        alt="Imagen circular"
        className=" 2xl:absolute  2xl:top-8 2xl:right-72 2xl:left-0    2xl:z-10  xl:absolute xl:top-52 xl:left-40 xl:z-10 2 xl:rounded-lg 2xl:w-6/12 xl:w-11/12 max-md:w-1/2  2xl:m-4 2xl:mt-52 2xl:ml-20 2xl:shadow-lg   animate__animated animate__fadeInRight max-md:mt-10   max-md:ml-8   "
      ></img>
